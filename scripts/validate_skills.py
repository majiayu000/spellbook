...
CATEGORY_BY_NAME = {
    ...
    "data-contract-migrations": "API & Backend",
    ...
    "release-engineering": "Operations & Deploy",
    # UI and frontend
    ...
    "incident-slo-runbook": "Operations & Deploy",
    "optimize-network": "Operations & Deploy",
    "performance-capacity": "Operations & Deploy",
    ...
    "blender-editable-3d": "Content & Research",
