...
| 8 | Running Extensions 截图 | 必须按扩展类型给出分级建议，并主动问用户是否要关闭/降载这些扩展 |
...
- 面对 Running Extensions 截图时，是否区分 AI/语言服务/调试自动附加/终端建议/Git 核心，而不是粗暴要求全关
- 列出可关闭扩展后，是否继续问用户要不要处理，并给出“只降载 Copilot / 关闭低风险组 / 大目录轻量扩展集 / 先不关”的选择
